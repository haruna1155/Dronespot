<div class="d-flex justify-content-sm-around">
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="card mt-3">
                <img class="card-img-top" src="img/test2.jpg" alt="posts"> {{-- $spot->photo --}}
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">スポット：</li> {{-- $spot->spot --}}
                    <li class="list-group-item">アクセス：</li> {{-- $spot->access --}}
                </ul>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="card mt-3">
                <img class="card-img-top" src="img/test3.jpg" alt="posts"> {{-- $spot->photo --}}
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">スポット：</li> {{-- $spot->spot --}}
                    <li class="list-group-item">アクセス：</li> {{-- $spot->access --}}
                </ul>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="card mt-3">
                <img class="card-img-top" src="img/test4.jpg" alt="posts"> {{-- $spot->photo --}}
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">スポット：</li> {{-- $spot->spot --}}
                    <li class="list-group-item">アクセス：</li> {{-- $spot->access --}}
                </ul>
